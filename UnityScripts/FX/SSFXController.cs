...
// Weapon types
    ...
    public class SSFXController : MonoBehaviour
    {
        // Singleton instance
        public static SSFXController instance;
        ...
        public SSFXType DefaultFXType; // Default starting weapon type
